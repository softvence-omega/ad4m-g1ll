  ...
  return (
    <div className="flex flex-col justify-between py-20 md:gap-16 lg:flex-row">
      <motion.div
        ...
        className="w-full flex-col items-start justify-center pl-20 md:flex md:w-fit"
      ...
      >
        <div className="py-6 md:py-20">
          ...
          >
            <h1 className="font-custom-font text-text-secondary text-4xl font-semibold text-nowrap lg:text-6xl xl:text-[144px]">
              We ARE
            </h1>
            <div className="mt-2 flex h-fit w-full flex-col items-center justify-center gap-4 lg:flex-row">
              <motion.div className="flex h-fit w-full items-center justify-center lg:h-32 lg:w-60">
                <video
                  autoPlay
                  loop
                  muted
              ...
              >
                <h1 className="text-text-tertiary font-grotesk-font text-4xl leading-tight font-semibold lg:text-6xl xl:text-[144px]">
                  NXDI
                </h1>
              </motion.div>
            </div>
      ...
      >
        <div className="text-center md:w-full md:max-w-2xl">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.5 }}
          >
            <h2 className="mb-8 text-4xl font-bold text-[#32529F] lg:text-[32px]">About NXDI</h2>
          </motion.div>
      ...
      >
        <div
          ...
          className="z-10 mt-20 justify-end pr-8 md:flex"
        >
